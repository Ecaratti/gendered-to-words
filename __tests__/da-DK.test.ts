...
const testIntegers: [number, string][] = [
  ...
  [
    975310864,
    "Ni Hundrede Femoghalvfjerds Million Tre Hundrede Ti Tusind Otte Hundrede Fireogtres",
  ],
  [
    9876543210,
    "Ni Milliard Otte Hundrede Seksoghalvfjerds Million Fem Hundrede Treogfyrre Tusind To Hundrede Ti",
  ],
  [
    98765432101,
    "Otteoghalvfems Milliard Syv Hundrede Femogtres Million Fire Hundrede Toogtredive Tusind Hundrede En",
  ],
  [
    987654321012,
