...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    localeCode: "es-ES",
    // TODO(native-review): RAE prescribes a period before the indicator ("1.º");
    // common digital usage omits it. Consumers can inject it via the parts API.
    ordinalIndicator: { suffixes: { masculine: { other: "º" }, feminine: { other: "ª" } } },
    texts: {
      minus: "Menos",
      point: "Punto",
    },
