...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    localeCode: "uk-UA",
    // TODO(native-review): feminine/neuter digit-ordinal suffixes vary per numeral
    // (-ша/-га/-тя), which CLDR plural categories cannot express; masculine -й is
    // uniform, and other genders fall back to it.
    ordinalIndicator: { suffixes: { masculine: { other: "-й" } } },
    texts: {
      minus: "Мінус",
      point: "Цілих",
    },
